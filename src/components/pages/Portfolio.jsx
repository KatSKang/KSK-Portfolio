...
const projBoxStyle =
  "grid md:grid-cols-3 sm:gap-8 lg:gap-12 h-full max-w-screen-xl px-8 py-8 mx-auto min-[320px]:grid-cols-1 max-w-s overflow-hidden my-12 mx-6 border-2 border-zinc-900 bg-zinc-100";
      ...
      <div className={projBoxStyle}>
        <div className="text-xl text-zinc-800 col-span-1 tracking-wide">
          ...
          <a
            ...
            className="inline-block rounded-lg px-3 py-1 text-base font-semibold text-zinc-900 my-4 mr-4 bg-white hover:text-[#d4776b] hover:bg-zinc-900 border border-zinc-900">
            See Live
          </a>
          <a
      ...
      <div className={projBoxStyle}>
        ...
        <div className="text-xl text-neutral-800 col-span-1">
          ...
          <a
            ...
            className="inline-block rounded-lg px-3 py-1 text-base font-semibold text-rose-300 mr-4 bg-white hover:bg-rose-300 hover:text-zinc-200 border border-rose-500">
            See Live
          </a>
          <a
            href="https://github.com/TeryKing/Project-MeowWoof"
            className="inline-blockpx-3 py-2 text-base font-semibold text-rose-400 hover:text-rose-200">
            Source Code
          </a>
        </div>
      </div>
